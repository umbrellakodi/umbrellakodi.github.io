...
_MYMOVIES_DEFAULTS = [
	...
	('mymv_custom_watchlist', '40736', 'custom_movies_watchlist&url=custommovieswatchlist',   'icon.png',   'icon.png',      1, 1, 1,  8, 0, 'custom_token',           0, None),
	('mymv_custom_collection','40737', 'custom_movies_collection&url=custommoviescollection', 'icon.png',   'icon.png',      1, 1, 1,  9, 0, 'custom_token',           0, None),
	('mymv_custom_unfinished','40741', 'custom_movies_unfinished&url=custommoviesunfinished', 'icon.png',   'icon.png',      1, 1, 1, 10, 0, 'custom_with_indicators', 1, '35308'),
	('mymv_custom_watched',   '40745', 'custom_movies_watched&url=custommovieswatched',       'icon.png',   'icon.png',      1, 1, 1, 11, 0, 'custom_with_indicators', 1, None),
	('mymv_tmdb_userlists',   'TMDb User Lists', 'tmdbUserListsMovies',                    'tmdb.png',      'tmdb.png',      1, 1, 1, 12, 0, 'tmdb_v4_token',        0, None),
	('mymv_tmdb_watchlist',   '40612', 'tmdbV4WatchlistMovies',                            'tmdb.png',      'tmdb.png',      1, 1, 1, 13, 0, 'tmdb_v4_token',        0, None),
	('mymv_simkl_completed',  '40548', 'movies&url=simklhistory',                          'simkl.png',     'simkl.png',     1, 1, 1, 14, 0, 'simkl_token',          0, None),
	('mymv_simkl_watchlist',  '40550', 'movies&url=simklwatchlist',                        'simkl.png',     'simkl.png',     1, 1, 1, 15, 0, 'simkl_token',          0, None),
	('mymv_simkl_dropped',    'Simkl Dropped', 'movies&url=simkldropped',                 'simkl.png',     'simkl.png',     1, 1, 1, 16, 0, 'simkl_token',          0, None),
	('mymv_trakt_unfinished', '40687', 'moviesUnfinished&url=traktunfinished',             'trakt.png',     'trakt.png',     1, 1, 1, 17, 0, 'trakt_with_indicators', 1, '35308'),
	('mymv_trakt_history',    '40695', 'movies&url=trakthistory',                          'trakt.png',     'trakt.png',     1, 1, 1, 18, 0, 'trakt_with_indicators', 1, '32036'),
	('mymv_trakt_watchlist',  '40696', 'movies&url=traktwatchlist',                        'trakt.png',     'trakt.png',     1, 1, 1, 19, 0, 'trakt_credentials',    0, '40700'),
	('mymv_trakt_collection', '40697', 'movies&url=traktcollection',                       'trakt.png',     'trakt.png',     1, 1, 1, 20, 0, 'trakt_credentials',    0, '32032'),
	('mymv_trakt_liked',      '40698', 'movies_LikedLists',                               'trakt.png',     'trakt.png',     1, 1, 1, 21, 0, 'trakt_credentials',     1, 'My Liked Lists'),
	('mymv_local_finish',     'Local: Finish Watching', 'local_finish_watching_movies',       'icon.png',      'icon.png',      1, 1, 1, 22, 0, 'local_scrobble',       1, None),
	('mymv_movies_menu',      '32031', 'movieliteNavigator',                               'movies.png',    'movies.png',    1, 1, 1, 23, 0, 'not_lite',             0, None),
	('mymv_person_search',    '33044', 'moviePerson',                                      'imdb.png',      'people-search.png', 0, 1, 1, 24, 0, 'not_lite',         0, None),
	('mymv_movie_search',     '33042', 'movieSearch',                                      'search.png',    'search.png',    1, 1, 1, 25, 0, 'not_lite',             0, None),
]
...
_MYTVSHOWS_DEFAULTS = [
	...
	('mytv_custom_watchlist',  '40736', 'custom_shows_watchlist&url=customshowswatchlist',       'icon.png',      'icon.png',      1, 1, 1, 12, 0, 'custom_token',           0, None),
	('mytv_custom_collection', '40737', 'custom_shows_collection&url=customshowscollection',     'icon.png',      'icon.png',      1, 1, 1, 13, 0, 'custom_token',           0, None),
	('mytv_custom_watched',    '40738', 'custom_shows_watched&url=customshowswatched',           'icon.png',      'icon.png',      1, 1, 1, 14, 0, 'custom_with_indicators', 1, '40433'),
	('mytv_custom_show_prog',  '40739', 'custom_shows_progress&url=customshowsprogress',         'icon.png',      'icon.png',      1, 1, 1, 15, 0, 'custom_with_indicators', 1, '40401'),
	('mytv_custom_ep_prog',    '40740', 'custom_episodes_progress&url=customepisodesprogress',   'icon.png',      'icon.png',      1, 1, 1, 16, 0, 'custom_with_indicators', 1, '32037'),
	('mytv_custom_unfinished', '40741', 'customEpisodesUnfinished&url=customepisodesunfinished', 'icon.png',      'icon.png',      1, 1, 1, 17, 0, 'custom_with_indicators', 1, '35308'),
	('mytv_custom_cal_recent', '40742', 'custom_calendar_recent&url=customcalendarrecent',       'icon.png',      'icon.png',      1, 1, 1, 18, 0, 'custom_with_indicators', 1, '32202'),
	('mytv_custom_cal_upcoming','40743','custom_calendar_upcoming&url=customcalendarupcoming',   'icon.png',      'icon.png',      1, 1, 1, 19, 0, 'custom_with_indicators', 1, '32203'),
	('mytv_custom_cal_premiers','40744','custom_calendar_premieres&url=customcalendarpremieres', 'icon.png',      'icon.png',      1, 1, 1, 20, 0, 'custom_with_indicators', 1, '32204'),
	('mytv_custom_upcoming',   '40753', 'custom_upcoming_progress&url=customupcomingprogress',   'icon.png',      'icon.png',      1, 1, 1, 21, 0, 'custom_with_indicators', 1, '32019'),
	('mytv_local_shows_prog',  '40658', 'local_shows_progress&url=localprogress',               'icon.png',      'icon.png',      1, 1, 1, 22, 0, 'local_scrobble',        1, None),
	('mytv_local_calendar',    '40659', 'local_calendar&url=localprogress',                     'icon.png',      'icon.png',      1, 1, 1, 23, 0, 'local_scrobble',        1, None),
	('mytv_local_finish',      'Local: Finish Watching', 'local_finish_watching_episodes',         'icon.png',      'icon.png',      1, 1, 1, 24, 0, 'local_scrobble',        1, None),
	('mytv_tmdb_userlists',    'TMDb User Lists', 'tmdbUserListsTV',                            'tmdb.png',      'tmdb.png',      1, 1, 1, 24, 0, 'tmdb_v4_token',         0, None),
	('mytv_tmdb_watchlist',    '40612', 'tmdbV4WatchlistTV',                                    'tmdb.png',      'tmdb.png',      1, 1, 1, 25, 0, 'tmdb_v4_token',         0, None),
	('mytv_simkl_ep_prog',     'Simkl Progress Episodes', 'simkl_calendar&url=/sync/all-items/shows/watching', 'simkl.png', 'simkl.png', 1, 1, 1, 26, 0, 'simkl_credentials', 1, None),
	('mytv_simkl_watching',    'Simkl Watching', 'tvshows&url=simklwatching',                  'simkl.png',     'simkl.png',     1, 1, 1, 27, 0, 'simkl_credentials',     1, None),
	('mytv_simkl_watchlist',   'Simkl Plan to Watch', 'tvshows&url=simklwatchlist',             'simkl.png',     'simkl.png',     1, 1, 1, 28, 0, 'simkl_credentials',     0, None),
	('mytv_simkl_onhold',      'Simkl On Hold', 'tvshows&url=simklonhold',                     'simkl.png',     'simkl.png',     1, 1, 1, 29, 0, 'simkl_credentials',     0, None),
	('mytv_simkl_completed',   'Simkl Completed', 'tvshows&url=simklhistory',                  'simkl.png',     'simkl.png',     1, 1, 1, 30, 0, 'simkl_credentials',     0, None),
	('mytv_simkl_dropped',     'Simkl Dropped', 'tvshows&url=simkldropped',                   'simkl.png',     'simkl.png',     1, 1, 1, 31, 0, 'simkl_credentials',     0, None),
	('mytv_trakt_unfinished',  '40687', 'episodesUnfinished&url=traktunfinished',               'trakt.png',     'trakt.png',     1, 1, 1, 32, 0, 'trakt_with_indicators',  1, '35308'),
	('mytv_trakt_ep_prog',     '40688', 'calendar&url=progress',                                'trakt.png',     'trakt.png',     1, 1, 1, 33, 0, 'trakt_with_indicators',  1, '32037'),
	('mytv_trakt_show_prog',   '40689', 'shows_progress&url=progresstv',                       'trakt.png',     'trakt.png',     1, 1, 1, 34, 0, 'trakt_with_indicators',  1, '40401'),
	('mytv_trakt_watched',     '40690', 'shows_watched&url=watchedtv',                         'trakt.png',     'trakt.png',     1, 1, 1, 35, 0, 'trakt_with_indicators',  1, '40433'),
	('mytv_trakt_upcoming',    '40691', 'upcomingProgress&url=progress',                       'trakt.png',     'trakt.png',     1, 1, 1, 36, 0, 'trakt_with_indicators',  1, '32019'),
	('mytv_trakt_cal_recent',  '40692', 'calendar&url=mycalendarRecent',                       'trakt.png',     'trakt.png',     1, 1, 1, 37, 0, 'trakt_with_indicators',  1, '32202'),
	('mytv_trakt_cal_upcoming','40693', 'calendar&url=mycalendarUpcoming',                     'trakt.png',     'trakt.png',     1, 1, 1, 38, 0, 'trakt_with_indicators',  1, '32203'),
	('mytv_trakt_cal_premiers','40694', 'calendar&url=mycalendarPremiers',                     'trakt.png',     'trakt.png',     1, 1, 1, 39, 0, 'trakt_with_indicators',  1, '32204'),
	('mytv_trakt_history',     '40695', 'calendar&url=trakthistory',                           'trakt.png',     'trakt.png',     1, 1, 1, 40, 0, 'trakt_with_indicators',  1, '32036'),
	('mytv_trakt_watchlist',   '40696', 'tvshows&url=traktwatchlist',                          'trakt.png',     'trakt.png',     1, 1, 1, 41, 0, 'trakt_credentials',     0, '40700'),
	('mytv_trakt_collection',  '40697', 'tvshows&url=traktcollection',                         'trakt.png',     'trakt.png',     1, 1, 1, 42, 0, 'trakt_credentials',     0, '32032'),
	('mytv_trakt_liked',       '40698', 'shows_LikedLists',                                    'trakt.png',     'trakt.png',     1, 1, 1, 43, 0, 'trakt_credentials',      1, 'My Liked Lists'),
	('mytv_tv_menu',           '32031', 'tvliteNavigator',                                     'tvshows.png',   'tvshows.png',   1, 1, 1, 44, 0, 'not_lite',              0, None),
	('mytv_person_search',     '33045', 'tvPerson',                                            'imdb.png',      'people-search.png', 0, 1, 1, 45, 0, 'not_lite',          0, None),
	('mytv_tv_search',         '33043', 'tvSearch',                                            'trakt.png',     'search.png',    1, 1, 1, 46, 0, 'not_lite',              0, None),
]
...
def _sync_defaults(dbcon):
	...
	_NEW_DEFAULT_ITEMS = [
		...
		('mytvshows', 'mytv_custom_watchlist',   '40736', 'custom_shows_watchlist&url=customshowswatchlist',       'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_token',           0, None),
		('mytvshows', 'mytv_custom_collection',  '40737', 'custom_shows_collection&url=customshowscollection',     'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_token',           0, None),
		('mytvshows', 'mytv_custom_watched',     '40738', 'custom_shows_watched&url=customshowswatched',           'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_with_indicators', 1, '40433'),
		('mytvshows', 'mytv_custom_show_prog',   '40739', 'custom_shows_progress&url=customshowsprogress',         'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_with_indicators', 1, '40401'),
		('mytvshows', 'mytv_custom_ep_prog',     '40740', 'custom_episodes_progress&url=customepisodesprogress',   'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_with_indicators', 1, '32037'),
		('mytvshows', 'mytv_custom_unfinished',  '40741', 'customEpisodesUnfinished&url=customepisodesunfinished', 'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_with_indicators', 1, '35308'),
		('mytvshows', 'mytv_custom_cal_recent',  '40742', 'custom_calendar_recent&url=customcalendarrecent',       'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_with_indicators', 1, '32202'),
		('mytvshows', 'mytv_custom_cal_upcoming','40743', 'custom_calendar_upcoming&url=customcalendarupcoming',   'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_with_indicators', 1, '32203'),
		('mytvshows', 'mytv_custom_cal_premiers','40744', 'custom_calendar_premieres&url=customcalendarpremieres','icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_with_indicators', 1, '32204'),
		('mytvshows', 'mytv_custom_upcoming',    '40753', 'custom_upcoming_progress&url=customupcomingprogress',   'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_with_indicators', 1, '32019'),
		('mymovies',  'mymv_custom_watchlist',   '40736', 'custom_movies_watchlist&url=custommovieswatchlist',     'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_token',           0, None),
		('mymovies',  'mymv_custom_collection',  '40737', 'custom_movies_collection&url=custommoviescollection',   'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_token',           0, None),
		('mymovies',  'mymv_custom_unfinished',  '40741', 'custom_movies_unfinished&url=custommoviesunfinished',   'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_with_indicators', 1, '35308'),
		('mymovies',  'mymv_custom_watched',     '40745', 'custom_movies_watched&url=custommovieswatched',         'icon.png', 'icon.png', 1, 1, 1, 99, 0, 'custom_with_indicators', 1, None),
	]
