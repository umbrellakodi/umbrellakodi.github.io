...
class Navigator:
	...
	def tools(self, folderName=''):
		...
		#-- Accounts - 7
		#self.addDirectoryItem(32044, 'tools_openSettings&query=10.1', 'tools.png', 'DefaultAddonService.png', isFolder=False)
	...
	def premium_services(self, folderName=''):
		...
		if getMenuEnabled('navi.offcloud'): self.addDirectoryItem(40527, 'oc_ServiceNavigator&folderName=%s' % quote_plus(getLS(40527)), 'offcloud.png', 'offcloud.png')
	...
	def alldebrid_service(self, folderName=''):
		...
		if getSetting('alldebridtoken'):
			...
			self.addDirectoryItem('[I]Please setup in Accounts[/I]', 'tools_openSettings&query=10.1', 'alldebrid.png', 'DefaultAddonService.png', isFolder=False)
		self.endDirectory()
	...
	def easynews_service(self, folderName=''):
		...
		if getSetting('easynews.user'):
			...
			self.addDirectoryItem('[I]Please setup in Accounts[/I]', 'tools_openSettings&query=10.1', 'easynews.png', 'DefaultAddonService.png', isFolder=False)
		self.endDirectory()
	...
	def offcloud_service(self):
		if getSetting('offcloudtoken'):
			...
			self.addDirectoryItem('[I]Please setup in Accounts[/I]', 'tools_openSettings&query=10.1', 'offcloud.png', 'DefaultAddonService.png', isFolder=False)
		self.endDirectory()
	...
	def realdebrid_service(self, folderName=''):
		...
		if getSetting('realdebridtoken'):
			...
			self.addDirectoryItem('[I]Please setup in Accounts[/I]', 'tools_openSettings&query=10.1', 'realdebrid.png', 'DefaultAddonService.png', isFolder=False)
		self.endDirectory()
