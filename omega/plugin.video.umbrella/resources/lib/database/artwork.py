...
def manager(type=None, imdb=None, tmdb=None, tvdb=None, season=None, episode=None):
	lists = []
	try:
...
def show_artwork_window(**kwargs):
	...
	try:
		...
		if not items: return control.notification(control.infoLabel('Container.ListItem.Title'), 'No %s artwork found.' % artworkType)
		control.hide()
